...
import com.example.debtspace.main.repositories.FriendRemovalRepository;
import com.example.debtspace.main.repositories.FriendRequestRepository;

public class FriendRemovalViewModel extends ViewModel {
    ...
    public void removeFriend(String username) {
        ...
        new FriendRemovalRepository(mContext).removeFriend(username, new OnUpdateDataListener() {
            @Override
